...
if(isset($_GET['rid']))
{
	...
	?>
	<script>
	window.location="UserRegistration.php?id=1";
	</script>
	<?php
	}
	...
	?>
	<script>
	window.location="SellerRegistration.php?id=2";
	</script>
	<?php
	}
}
...
<body>
	...
	<center>
		<br>
	<a id="resendButton" class="button-link" href="OTPregistration.php?rid=<?php echo $_GET['emid'];?>"style="width:50px;align-content: center;" >Resend</a>
					...
					if (this.value >= 0 && this.value <= 9) {
						if (index < otpDigits.length - 1) {
							...
							if (isValidOTP(enteredOTP)) {
								$.ajax({
										url:"../Assets/AjaxPages/AjaxOTP.php?OTP="+enteredOTP,
